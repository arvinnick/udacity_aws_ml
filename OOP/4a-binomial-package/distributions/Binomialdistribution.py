...
class Binomial(Distribution):
    ...
    Fill out all TODOs in the functions below
    ...
    def replace_stats_with_data(self,file_name="./numbers_binomial.txt"):
        ...
        self.p = np.count_nonzero(self.data) / len(self.data)
    ...
    def plot_bar_pdf(self):
        ...
        y = [self.pdf(k, self.n, self.p) for k in range(self.n)]
        plt.bar(y)
        plt.title("binomial bar plot")
        plt.show()
        return x, y
    ...
    def __add__(self, other):
        ...
        new_binom = Binomial(self.p, new_n)
